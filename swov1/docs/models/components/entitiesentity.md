...
| ~~`healthscore`~~                                                                                                               | [components.Healthscore](../../models/components/healthscore.md)                                                                | :heavy_minus_sign:                                                                                                              | : warning: ** DEPRECATED **: This will be removed in a future release, please migrate away from it as soon as possible.         | {<br/>"score": 100,<br/>"category": "good"<br/>}                                                                                |
