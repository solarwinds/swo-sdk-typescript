...
```typescript
import { UriAvailabilityCheckSettingsInputOutageConfiguration } from "@solarwinds/swo-sdk-typescript/models/components";

let value: UriAvailabilityCheckSettingsInputOutageConfiguration = {
