...
```typescript
import { DemTransactionTestDefinitionOutageConfiguration } from "@solarwinds/swo-sdk-typescript/models/components";

let value: DemTransactionTestDefinitionOutageConfiguration = {
