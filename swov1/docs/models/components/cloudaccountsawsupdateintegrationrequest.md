...
```typescript
import { CloudAccountsAwsUpdateIntegrationRequest } from "@solarwinds/swo-sdk-typescript/models/components";

let value: CloudAccountsAwsUpdateIntegrationRequest = {
