...
```typescript
import { UriAvailabilityCheckSettingsOutageConfiguration } from "@solarwinds/swo-sdk-typescript/models/components";

let value: UriAvailabilityCheckSettingsOutageConfiguration = {
