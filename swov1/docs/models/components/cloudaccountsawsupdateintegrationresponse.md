...
```typescript
import { CloudAccountsAwsUpdateIntegrationResponse } from "@solarwinds/swo-sdk-typescript/models/components";

let value: CloudAccountsAwsUpdateIntegrationResponse = {
  selectedRegions: [],
  externalId: "<id>",
  integrationId: "<id>",
