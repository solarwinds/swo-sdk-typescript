...
```typescript
import { DemGetWebsiteResponseOutageConfiguration } from "@solarwinds/swo-sdk-typescript/models/components";

let value: DemGetWebsiteResponseOutageConfiguration = {
