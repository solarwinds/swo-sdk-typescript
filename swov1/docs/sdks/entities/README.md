...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("entitiesListEntities failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("entitiesGetEntityById failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("entitiesUpdateEntityById failed:", res.error);
  }
}
