 ...
 */
export function demUnpauseWebsiteMonitoring(
  client: SwoCore,
  ...
  Result<
    components.EntityId,
    | errors.UnpauseWebsiteMonitoringNotFoundError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UnpauseWebsiteMonitoringRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/dem/websites/{entityId}/unpauseMonitoring")(
    pathParams,
  );
  ...
  >(
    ...
    M.jsonErr(404, errors.UnpauseWebsiteMonitoringNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
