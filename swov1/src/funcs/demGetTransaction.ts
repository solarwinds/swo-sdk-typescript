 ...
 */
export function demGetTransaction(
  client: SwoCore,
  request: operations.GetTransactionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.DemGetTransactionResponse,
...
> {
  ...
  const path = pathToFunc("/v1/dem/transactions/{entityId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.DemGetTransactionResponse$inboundSchema),
