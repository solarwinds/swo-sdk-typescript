 ...
 */
export function dboGetPluginConfig(
  client: SwoCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPluginConfigRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/dbo/databases/{entityId}/pluginConfig")(
    pathParams,
  );
