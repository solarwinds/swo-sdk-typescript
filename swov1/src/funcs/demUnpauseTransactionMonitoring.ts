 ...
 */
export function demUnpauseTransactionMonitoring(
  client: SwoCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UnpauseTransactionMonitoringRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/dem/transactions/{entityId}/unpauseMonitoring")(
    pathParams,
  );
