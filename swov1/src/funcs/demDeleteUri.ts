...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteUriRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/dem/uris/{entityId}")(pathParams);
  ...
  >(
    ...
    M.jsonErr(404, errors.DeleteUriNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
