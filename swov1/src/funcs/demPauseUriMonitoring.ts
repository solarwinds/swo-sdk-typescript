 ...
 */
export function demPauseUriMonitoring(
  client: SwoCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PauseUriMonitoringRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/dem/uris/{entityId}/pauseMonitoring")(
    pathParams,
  );
