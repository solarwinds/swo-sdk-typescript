 ...
 */
export function metadataListEntityTypes(
  client: SwoCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListEntityTypesResponse,
    | SwoError
...
> {
  const path = pathToFunc("/v1/metadata/entities/types")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListEntityTypesResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
