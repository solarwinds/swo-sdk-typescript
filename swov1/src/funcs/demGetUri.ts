 ...
 */
export function demGetUri(
  client: SwoCore,
  request: operations.GetUriRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetUriResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetUriRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetUriResponse$inboundSchema),
