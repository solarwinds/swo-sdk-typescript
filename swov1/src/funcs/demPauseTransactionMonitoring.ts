 ...
 */
export function demPauseTransactionMonitoring(
  client: SwoCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PauseTransactionMonitoringRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/dem/transactions/{entityId}/pauseMonitoring")(
    pathParams,
  );
