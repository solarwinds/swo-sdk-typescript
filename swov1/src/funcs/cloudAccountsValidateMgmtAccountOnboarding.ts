 ...
 */
export function cloudAccountsValidateMgmtAccountOnboarding(
  client: SwoCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ValidateMgmtAccountOnboardingRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/cloud/aws/controlTower/validateOnboarding")();
