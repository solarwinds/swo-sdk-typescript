...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPluginsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/dbo/databases/{entityId}/plugins")(pathParams);
