 ...
 */
export function metricsListMetricMeasurements(
  client: SwoCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.ListMetricMeasurementsNotFoundError
      | SwoError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListMetricMeasurementsRequest$outboundSchema.parse(value),
  ...
  const query = options?.[URL_OVERRIDE]
    ...
    : encodeFormQuery({
      ...
      "preGroupBy": payload.preGroupBy,
      "preGroupByMethod": payload.preGroupByMethod,
  ...
  >(
    ...
    M.jsonErr(404, errors.ListMetricMeasurementsNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
