 ...
 */
export function demPauseWebsiteMonitoring(
  client: SwoCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PauseWebsiteMonitoringRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/dem/websites/{entityId}/pauseMonitoring")(
    pathParams,
  );
