 ...
 * Get test results
 */
export function demGetUriTestResults(
  client: SwoCore,
  ...
  PageIterator<
    Result<
      operations.GetUriTestResultsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetUriTestResultsRequest$outboundSchema.parse(value),
  ...
  const path = options?.[URL_OVERRIDE]
    ...
    : pathToFunc("/v1/dem/uris/{entityId}/testResults")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetUriTestResultsResponse$inboundSchema, {
      key: "Result",
    }),
