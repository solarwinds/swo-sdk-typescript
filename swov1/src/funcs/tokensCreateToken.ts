...
export function tokensCreateToken(
  ...
  Result<
    ...
    | errors.CommonUnavailableErrorResponse
    | SwoError
...
> {
  ...
  const path = pathToFunc("/v1/tokens")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.TokensCreateTokenResponse$inboundSchema),
    ...
    M.jsonErr(503, errors.CommonUnavailableErrorResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
