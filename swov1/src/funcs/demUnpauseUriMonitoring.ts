 ...
 */
export function demUnpauseUriMonitoring(
  client: SwoCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UnpauseUriMonitoringRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/dem/uris/{entityId}/unpauseMonitoring")(
    pathParams,
  );
