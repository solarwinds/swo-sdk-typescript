 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace MetricsMeasurementsRequest$ {
  /** @deprecated use `MetricsMeasurementsRequest$inboundSchema` instead. */
  export const inboundSchema = MetricsMeasurementsRequest$inboundSchema;
  /** @deprecated use `MetricsMeasurementsRequest$outboundSchema` instead. */
  export const outboundSchema = MetricsMeasurementsRequest$outboundSchema;
  /** @deprecated use `MetricsMeasurementsRequest$Outbound` instead. */
  export type Outbound = MetricsMeasurementsRequest$Outbound;
}
