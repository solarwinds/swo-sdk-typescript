 ...
 */
export namespace DboDatabaseConnectionOptions$ {
  /** @deprecated use `DboDatabaseConnectionOptions$inboundSchema` instead. */
  export const inboundSchema = DboDatabaseConnectionOptions$inboundSchema;
  /** @deprecated use `DboDatabaseConnectionOptions$outboundSchema` instead. */
  export const outboundSchema = DboDatabaseConnectionOptions$outboundSchema;
  /** @deprecated use `DboDatabaseConnectionOptions$Outbound` instead. */
  export type Outbound = DboDatabaseConnectionOptions$Outbound;
}
