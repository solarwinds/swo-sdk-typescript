 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace EntitiesEntity$ {
  /** @deprecated use `EntitiesEntity$inboundSchema` instead. */
  export const inboundSchema = EntitiesEntity$inboundSchema;
  /** @deprecated use `EntitiesEntity$outboundSchema` instead. */
  export const outboundSchema = EntitiesEntity$outboundSchema;
  /** @deprecated use `EntitiesEntity$Outbound` instead. */
  export type Outbound = EntitiesEntity$Outbound;
}
