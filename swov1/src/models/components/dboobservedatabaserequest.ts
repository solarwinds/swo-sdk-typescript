 ...
 */
export namespace DboObserveDatabaseRequest$ {
  /** @deprecated use `DboObserveDatabaseRequest$inboundSchema` instead. */
  export const inboundSchema = DboObserveDatabaseRequest$inboundSchema;
  /** @deprecated use `DboObserveDatabaseRequest$outboundSchema` instead. */
  export const outboundSchema = DboObserveDatabaseRequest$outboundSchema;
  /** @deprecated use `DboObserveDatabaseRequest$Outbound` instead. */
  export type Outbound = DboObserveDatabaseRequest$Outbound;
}
